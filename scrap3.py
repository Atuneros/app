...
url = 'https://www.bolsavalencia.es/esp/aspx/Mercados/Precios.aspx?indice=ESI100000000'
...
f = open("datos_valencia.txt", "a")

for x in empresasDict:
    f.write(json.dumps(empresasDict[x]))
    f.write("\n")